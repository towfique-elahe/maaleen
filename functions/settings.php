...
function maaleen_advanced_theme_support() {
...
add_action('after_setup_theme', 'maaleen_advanced_theme_support');

/**
 * Add Elementor Support
 */
function maaleen_add_elementor_support() {
...
add_action('after_setup_theme', 'maaleen_add_elementor_support');
...
function maaleen_register_menus() {
    register_nav_menus([
        'primary-menu'   => __('Primary Menu', 'maaleen'),
        'footer-menu'  => __('Footer Menu', 'maaleen'),
    ]);
}
add_action('init', 'maaleen_register_menus');

/**
 * Display a fallback menu when no menu is assigned.
 */
function maaleen_fallback_menu() {
    echo '<ul class="fallback-menu">';
    echo '<li><a href="' . esc_url(home_url('/')) . '">' . __('Home', 'maaleen') . '</a></li>';
    echo '<li><a href="' . esc_url(home_url('/about')) . '">' . __('About', 'maaleen') . '</a></li>';
    echo '<li><a href="' . esc_url(home_url('/contact')) . '">' . __('Contact', 'maaleen') . '</a></li>';
    echo '</ul>';
}
 ...
 */
class maaleen_Custom_Nav_Walker extends Walker_Nav_Menu {
 ...
 */
function maaleen_display_menu($theme_location) {
    if (has_nav_menu($theme_location)) {
        wp_nav_menu([
            'theme_location' => $theme_location,
            'container'      => 'nav',
            'container_class'=> 'maaleen-nav',
            'menu_class'     => 'maaleen-menu',
            'fallback_cb'    => 'maaleen_fallback_menu',
            'walker'         => new maaleen_Custom_Nav_Walker(),
        ]);
    } else {
        maaleen_fallback_menu();
    }
}
 ...
 */
function maaleen_widgets_init() {
    register_sidebar( array(
        'name'          => __( 'Main Sidebar', 'maaleen' ),
        'id'            => 'sidebar-1',
        'description'   => __( 'Widgets in this area will be shown on the sidebar.', 'maaleen' ),
...
add_action( 'widgets_init', 'maaleen_widgets_init' );