...
function maaleen_register_styles() {
    ...
    wp_enqueue_style('maaleen-style', get_stylesheet_uri(), [], $version);
...
add_action('wp_enqueue_scripts', 'maaleen_register_styles');

// Register and enqueue scripts
function maaleen_register_scripts() {
    $version = wp_get_theme()->get('Version');
...
add_action('wp_enqueue_scripts', 'maaleen_register_scripts');